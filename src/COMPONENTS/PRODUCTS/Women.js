...
import './product.css'
import womenimg from './img/p11.jpg'
...
export default function Women() {
  return (
    <>
      <Nav />
      <div className='container womenbgimg'>
        <h1 className='heddinggg'>Women Collections</h1>
      </div >
          ...
          <div class="col-sm-3">
            <div class="dress-card">
              <div class="dress-card-head">
                <img class="dress-card-img-top" src={womenimg} alt=""></img>
              </div>
